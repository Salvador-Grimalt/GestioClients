...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    private void InitTaula() {
        ...
        dtm.setColumnIdentifiers(new String[]{"Nom", "Cognoms", "Data Alta", "Provincia"});
        jTableClients.setModel(dtm);
    }
    
    public void afegirClient(Client client){
        DefaultTableModel dtm = (DefaultTableModel)jTableClients.getModel();
    ...
    private static final Logger LOG = Logger.getLogger(PantallaPrincipal.class.getName());
